...
namespace PersimosMVC.Controllers
{
    public class FacturasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Monto,Paciente")] Facturas facturas)
        {
            ...
            ViewBag.Paciente = new SelectList(db.Pacientes, "id", "Paciente", facturas.Paciente);
            return View(facturas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Monto,Paciente")] Facturas facturas)
        {
            if (ModelState.IsValid)
            {
