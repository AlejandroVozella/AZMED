...
namespace PersimosMVC.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Nombre,Cantidad")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Nombre,Cantidad")] Material material)
        {
            if (ModelState.IsValid)
            {
